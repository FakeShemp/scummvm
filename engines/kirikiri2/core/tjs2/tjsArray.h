...
#ifndef KIRIKIRI2_CORE_TJS2_TJS_ARRAY_H
#define KIRIKIRI2_CORE_TJS2_TJS_ARRAY_H
...
public:
	...
	void operator+=(const tjs_char *string) { Append(string, TJS_strlen(string)); }

	void operator+=(const ttstr &string) { Append(string.c_str(), string.GetLen()); }
};
//---------------------------------------------------------------------------
