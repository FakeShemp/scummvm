...
const tjs_char *TJSVariantTypeToTypeString(tTJSVariantType type) {
	switch (type) {
	case tvtVoid:
		return (const tjs_char *)TJS_W("void");
	case tvtInteger:
		return (const tjs_char *)TJS_W("int");
	case tvtReal:
		return (const tjs_char *)TJS_W("real");
	case tvtString:
		return (const tjs_char *)TJS_W("string");
	case tvtOctet:
		return (const tjs_char *)TJS_W("octet");
	case tvtObject:
		return (const tjs_char *)TJS_W("object");
	}
...
template<tjs_int size>
struct tTJSPointerSizedIntegerBase { typedef long type; };
template<>
struct tTJSPointerSizedIntegerBase<8> { typedef tjs_uint64 type; };
template<>
struct tTJSPointerSizedIntegerBase<4> { typedef tjs_uint32 type; };
