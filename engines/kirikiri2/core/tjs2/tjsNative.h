...
//---------------------------------------------------------------------------
#ifndef KIRIKIRI2_CORE_TJS2_TJS_NATIVE_H
#define KIRIKIRI2_CORE_TJS2_TJS_NATIVE_H
...
//---------------------------------------------------------------------------
typedef tjs_error(TJS_INTF_METHOD *tTJSNativeClassMethodCallback)(tTJSVariant *result, tjs_int numparams, tTJSVariant **param,
...
//---------------------------------------------------------------------------
typedef tjs_error(TJS_INTF_METHOD *tTJSNativeClassPropertyGetCallback)(tTJSVariant *result, iTJSDispatch2 *objthis);
typedef tjs_error(TJS_INTF_METHOD *tTJSNativeClassPropertySetCallback)(const tTJSVariant *param, iTJSDispatch2 *objthis);
/*]*/
#ifdef __TP_STUB_H__
/*[*/
...
//---------------------------------------------------------------------------
inline TJS_EXP_FUNC_DEF(void, TJSNativeClassRegisterNCM, (tTJSNativeClass * cls, const tjs_char *name, iTJSDispatch2 *dsp, const tjs_char *classname, tTJSNativeInstanceType type, tjs_uint32 flags = 0)) {
	cls->RegisterNCM(name, dsp, classname, type, flags);
}
//---------------------------------------------------------------------------
inline TJS_EXP_FUNC_DEF(void, TJSNativeClassSetClassID, (tTJSNativeClass * cls, tjs_int32 classid)) {
...
public:
	tTJSNativeClassForPlugin(const ttstr &name,
							 tTJSCreateNativeInstance proc) : procCreateNativeInstance(proc), tTJSNativeClass(name) {
		;
	}
...
#define TJS_DENY_NATIVE_PROP_GETTER                           \
	static tjs_error TJS_INTF_METHOD Get(tTJSVariant *result, \
										 iTJSDispatch2 *objthis) { return TJS_E_ACCESSDENYED; }
