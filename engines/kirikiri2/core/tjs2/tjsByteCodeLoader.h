...
#ifndef KIRIKIRI2_CORE_TJS2_TJS_BYTE_CODE_LOADER_H
#define KIRIKIRI2_CORE_TJS2_TJS_BYTE_CODE_LOADER_H
...
private:
	...
	static inline tjs_uint64 read8byte(const tjs_uint8 *x) {
		return ((tjs_uint64)(x[0]) | ((tjs_uint64)(x[1]) << 8) | ((tjs_uint64)(x[2]) << 16) | ((tjs_uint64)(x[3]) << 24) | ((tjs_uint64)(x[4]) << 32) | ((tjs_uint64)(x[5]) << 40) | ((tjs_uint64)(x[6]) << 48) | ((tjs_uint64)(x[7]) << 56));
	}
