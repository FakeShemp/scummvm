...
//---------------------------------------------------------------------------
#ifndef KIRIKIRI2_CORE_TJS2_TJS_INTER_CODE_GEN_H
#define KIRIKIRI2_CORE_TJS2_TJS_INTER_CODE_GEN_H
...
//---------------------------------------------------------------------------
enum tTJSSubType { stNone = VM_NOP,
				   stEqual = VM_CP,
				   stBitAND = VM_BAND,
				   stBitOR = VM_BOR,
				   stBitXOR = VM_BXOR,
				   ...
				   stTypeOf };
//---------------------------------------------------------------------------
enum tTJSFuncArgType { fatNormal,
					   fatExpand,
					   fatUnnamedExpand };
//---------------------------------------------------------------------------
...
private:
	...
	struct tFixData {
		...
		tFixData(tjs_int startip, tjs_int size, tjs_int newsize,
				 tjs_int32 *code, bool beforeinsertion) { StartIP = startip, Size = size, NewSize = newsize,
