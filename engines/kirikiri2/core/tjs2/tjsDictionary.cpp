...
tTJSDictionaryClass::tTJSDictionaryClass() : tTJSNativeClass(TJS_W("Dictionary")) {
...
iTJSDispatch2 *TJSCreateDictionaryObject(iTJSDispatch2 **classout) {
	...
	(dictionaryclass.Obj)->CreateNew(0, NULL, NULL, (iTJSDispatch2 **)&dictionaryobj, 0, NULL, dictionaryclass.Obj);
