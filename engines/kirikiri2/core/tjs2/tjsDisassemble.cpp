...
#undef OP1A_DISASM
		...
		case VM_NEW: {
			...
			msg.printf(
				CodeArea[i] == VM_CALL ? TJS_W("call %%%d, %%%d(") : CodeArea[i] == VM_CALLD ? TJS_W("calld %%%d, %%%d.*%d(")
		...
		case VM_GPDS:
			// property get direct
			msg.printf(
				CodeArea[i] == VM_GPD ? TJS_W("gpd %%%d, %%%d.*%d") : TJS_W("gpds %%%d, %%%d.*%d"),
				TJS_FROM_VM_REG_ADDR(CodeArea[i + 1]),
				TJS_FROM_VM_REG_ADDR(CodeArea[i + 2]),
				TJS_FROM_VM_REG_ADDR(CodeArea[i + 3]));
			if (DataArea) {
		...
		case VM_SPDS:
			// property set direct
			msg.printf(
				CodeArea[i] == VM_SPD ? TJS_W("spd %%%d.*%d, %%%d") : CodeArea[i] == VM_SPDE ? TJS_W("spde %%%d.*%d, %%%d")
		...
		case VM_GPIS:
			...
			msg.printf(
				CodeArea[i] == VM_GPI ? TJS_W("gpi %%%d, %%%d.%%%d") : TJS_W("gpis %%%d, %%%d.%%%d"),
				TJS_FROM_VM_REG_ADDR(CodeArea[i + 1]),
				TJS_FROM_VM_REG_ADDR(CodeArea[i + 2]),
				TJS_FROM_VM_REG_ADDR(CodeArea[i + 3]));
			size = 4;
		...
		case VM_SPIS:
			...
			msg.printf(
				CodeArea[i] == VM_SPI ? TJS_W("spi %%%d.%%%d, %%%d") : CodeArea[i] == VM_SPIE ? TJS_W("spie %%%d.%%%d, %%%d")
																							  : TJS_W("spis %%%d.%%%d, %%%d"),
				TJS_FROM_VM_REG_ADDR(CodeArea[i + 1]),
				TJS_FROM_VM_REG_ADDR(CodeArea[i + 2]),
				TJS_FROM_VM_REG_ADDR(CodeArea[i + 3]));
		...
		case VM_TYPEOFD:
			...
			msg.printf(
				CodeArea[i] == VM_DELD ? TJS_W("deld %%%d, %%%d.*%d") : TJS_W("typeofd %%%d, %%%d.*%d"),
				TJS_FROM_VM_REG_ADDR(CodeArea[i + 1]),
				TJS_FROM_VM_REG_ADDR(CodeArea[i + 2]),
				TJS_FROM_VM_REG_ADDR(CodeArea[i + 3]));
			if (DataArea) {
		...
		case VM_TYPEOFI:
			...
			msg.printf(
				CodeArea[i] == VM_DELI ? TJS_W("deli %%%d, %%%d.%%%d") : TJS_W("typeofi %%%d, %%%d.%%%d"),
				TJS_FROM_VM_REG_ADDR(CodeArea[i + 1]),
				TJS_FROM_VM_REG_ADDR(CodeArea[i + 2]),
				TJS_FROM_VM_REG_ADDR(CodeArea[i + 3]));
			size = 4;
