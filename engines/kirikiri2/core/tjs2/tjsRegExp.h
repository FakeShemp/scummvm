...
//---------------------------------------------------------------------------
#ifndef KIRIKIRI2_CORE_TJS2_TJS_REG_EXP_H
#define KIRIKIRI2_CORE_TJS2_TJS_REG_EXP_H
...
gcc g++ has a lack of wstring.
	...
	include /
		g++ -
	3 / string : uncomment this : typedef basic_string<wchar_t> wstring;
...
is not usable in wstring;
fix like

{
	static charT zero = (charT)0;
	if (length() == 0)
		return &zero;
	terminate();
	return data();
