...
TJS_EXP_FUNC_DEF(tTJSVariantOctet *, TJSAllocVariantOctet, (const tjs_uint8 *data1, tjs_uint len1, const tjs_uint8 *data2, tjs_uint len2));
TJS_EXP_FUNC_DEF(tTJSVariantOctet *, TJSAllocVariantOctet, (const tTJSVariantOctet *o1, const tTJSVariantOctet *o2));
...
public:
	...
	tTJSVariantClosure(iTJSDispatch2 *obj, iTJSDispatch2 *objthis = NULL) { Object = obj, ObjThis = objthis; }
