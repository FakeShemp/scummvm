...
#ifndef KIRIKIRI2_ComplexRectUnitH
#define KIRIKIRI2_ComplexRectUnitH
...
public: // comparison operators for sorting
	...
	// comparison methods
	bool operator==(const tTVPRect &rhs) const { return top == rhs.top && left == rhs.left && right == rhs.right && bottom == rhs.bottom; }
